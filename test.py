...
smng=[smng_primakov,smng_geoarctic,smng_nemchinov,smng_lazarev]
test=[]
text=[]
...
print(config.vessel_info("TEST",text[0]))
print(config.vessel_info("TEST",text[1]))
print(config.vessel_info("TEST",text[2]))
